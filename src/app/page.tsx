      ...
      <div className="max-w-sm w-full bg-white p-6 rounded-2xl shadow-lg">
        ...
        <ul className="space-y-3">
          ...
          <li className="flex items-center justify-between">
            ...
            <time className="bg-indigo-50 rounded-lg px-2 py-3 text-xs text-blue-800">12:00 PM</time>
          </li>
          ...
          <li className="flex items-center justify-between">
            ...
            <time className="bg-indigo-50 rounded-lg px-3 py-3 text-xs text-blue-800">1:00 PM</time>
          </li>
          ...
          <li className="flex items-center justify-between">
            ...
            <time className="bg-indigo-50 rounded-lg px-3 py-3 text-xs text-blue-800">4:20 PM</time>
          </li>
          ...
          <li className="flex items-center justify-between">
            ...
            <time className="bg-indigo-50 rounded-lg px-3 py-3 text-xs text-blue-800">9:00 PM</time>
          </li>
          ...
          <li className="flex items-center justify-between">
            <span className="flex items-center gap-4 bg-indigo-50 rounded-lg px-3 py-2 flex-1 mr-2">
              <span className="h-5 w-5 flex items-center justify-center bg-white rounded-full"></span>
              <span className="text-slate-700">Take out trash</span>
            </span>
            <time className="bg-indigo-50 rounded-lg px-3 py-3 text-xs text-blue-800">9:00 AM</time>
          </li>
        </ul>
